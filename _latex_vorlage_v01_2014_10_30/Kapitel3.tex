...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.25\textwidth]{pics/PAP_PCL.pdf}
...
Nach der Einführung von Koordinatensystemen und der Beschreibung der Sensordatenverarbeitung wird in diesem Abschnitt der Kern des Modells, die Implementierung von Occupancy Grid, erläutert. Sie umfasst die Implementierung von 2 Ebenen, wie in Abbildung~\ref{fig:EbeneVonOccupancyGrid} dargestellt.
