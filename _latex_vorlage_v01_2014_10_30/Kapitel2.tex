...
\begin{longtable}{|m{0.15\textwidth}<{\centering}|m{0.4\textwidth}<{\centering}|m{0.4\textwidth}<{\centering}|}
	...
	\begin{itemize}  
		...
		\item volle $360^0$- und 3D-Punktwolken bieten 
