...
\begin{figure}[htbp]
	...
	\caption{Bestandteile des Modells Occupancy Grid Map}
...
\\Es ist erwähnenswert, dass Kameras aufgrund ihrer niedrigen Preise akademisch und industriell beliebt sind. Es wird häufig verwendet, um objektbasierte Umfeldmodelle mithilfe von Computer Vision zu erstellen. Immer mehr Algorithmen werden entwickelt, um die Tiefeninformation von Bildern zu berechnen. Kamera ist jedoch für die Einrichtung von Occupancy Grid Map nicht so direkt wie LiDAR-Sensor, das zweidimensionale oder dreidimensionale Tiefeninformationen mit einem längeren Erfassungsbereich liefert. Obwohl die Erkennungsqualität begrenzt ist, wurde aus historischen Gründen eine große Anzahl von Radargeräten an Testfahrzeugen angebracht, sodass die Radar-basierte Forschung und Entwicklung noch nicht abgeschlossen ist. Der Preis von LiDAR-Senor ist relativ hoch, aber sein absoluter Vorteil liegt in der Genauigkeit und Auflösung von Tiefeninformationen und Positionsinformationen, und es eignet sich für die Erstellung von Occupancy Grid Map.
